...
규칙:
1. parties: 법적 주체만. 목적물(X토지, 어음)은 제외. 역할어(원고/피고/피고인/피해자/회사)도 당사자로 포함. 법원·검찰은 제외. 당사자 표기는 지문 문자열을 그대로 쓰고 절대 변환하지 마라(한글 갑·을, 한자 甲·乙, 영문 A·B, A주식회사 등). '갑의 채권자'처럼 소유격 수식으로 지칭된 자는, 그 자신이 행위 주체일 때 '채권자' 단독으로 표기하라.
